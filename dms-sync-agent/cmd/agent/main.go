...
import (
        ...
        "github.com/dms/dms-sync-agent/internal/config"
        "github.com/dms/dms-sync-agent/internal/queue"
        "github.com/dms/dms-sync-agent/internal/service"
        "github.com/dms/dms-sync-agent/internal/uploader"
        "github.com/dms/dms-sync-agent/internal/watcher"
...
func main() {
        ...
        if *showVersion {
                fmt.Printf("DMS Sync Agent v%s (Build: %s)\n", Version, BuildTime)
                os.Exit(0)
        }
...
func setupLogging(cfg *config.Config) {
        ...
        logPath := cfg.LogPath
        if logPath == "" {
                logPath = filepath.Join(os.Getenv("ProgramData"), "DMSSyncAgent", "logs")
        }
